...
const SidebarContext = createContext<SidebarContextProperties | null>(null);
...
function SidebarProvider({
  ...
  // Keep cookie in sync with open state
  useEffect(() => {
...
function SidebarMenuSkeleton({
  ...
  const width = useMemo(() => {
    ...
    return `${Math.floor((array[0] / (0xff_ff_ff_ff + 1)) * 40) + 50}%`;
  }, []);
