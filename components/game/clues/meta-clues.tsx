...
export function MetaClues() {
  ...
  return (
    <div className="flex flex-col gap-4 md:gap-5 md:justify-center md:h-full py-1">
      {clues.map((clue) => (
        <div key={clue.label} className="flex flex-col gap-1">
          ...
          <span
            className={`font-[family-name:var(--font-playfair)] text-base tracking-[0.12em] leading-tight ${(clue.value === "•••" || clue.value === "••••") ? "opacity-30" : ""}`}
          >
